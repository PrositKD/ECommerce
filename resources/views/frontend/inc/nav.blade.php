            ...
            <div class="container">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-none d-xl-block ml-auto mr-0">
                        @auth
                            <span
                                class="d-flex align-items-center nav-user-info py-10px @if (isAdmin()) ml-5 @endif"
                                id="nav-user-info">
                                <!-- Image -->
                                <span
        ...
        <div class="d-none d-lg-block position-relative  h-50px">
            <div class="container h-100">
                <div class="d-flex h-100">
                    ...
                    @php
                        $categories = \App\Models\Category::where('parent_id', 0)->limit(16)->orderBy('order_level', 'desc')->get();
                        $nav_txt_color = ((get_setting('header_nav_menu_text') == 'light') ||  (get_setting('header_nav_menu_text') == null)) ? 'text-white' : 'text-dark';
                    @endphp
                    <div class="ml-xl-4 w-100 overflow-hidden">
                        <div class="d-flex align-items-center justify-content-center justify-content-xl-start h-100">
    ...
    <div class="aiz-top-menu-sidebar collapse-sidebar-wrap sidebar-xl sidebar-left d-lg-none z-1035">
        ...
        <div class="collapse-sidebar c-scrollbar-light text-left">
            ...
            <ul class="mb-0 pl-3 pb-3 h-100">
                ...
                @endif --}}
                @php
                    $categories = \App\Models\Category::where('parent_id', 0)->limit(12)->orderBy('order_level', 'desc')->get();
                    $nav_txt_color = ((get_setting('header_nav_menu_text') == 'light') ||  (get_setting('header_nav_menu_text') == null)) ? 'text-white' : 'text-dark';
                @endphp
                <li class="mr-0">
                    <a href="{{ route('search') }}"
