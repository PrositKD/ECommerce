        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-12 policy-file">
                <a class="text-reset h-100 text-center d-block hov-ls-1">
                    <img src="{{ static_asset('assets/img/Website-Footer-Ribbon.webp') }}" alt="{{ env('APP_NAME') }} promo"
...
@php
    $col_values = ((get_setting('vendor_system_activation') == 1) || addon_is_activated('delivery_boy')) ? "col-lg-3 col-md-6 col-sm-6" : "col-md-3 col-sm-6";
@endphp
    ...
    <div class="container d-none d-lg-block">
        <div class="row">
            ...
            <div class="{{ $col_values }}">
             ...
             <div class="{{ $col_values }}">
                    <div class="text-center text-sm-left mt-3">
                        <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('Pages') }}</h4>
                        <ul class="list-unstyled">
                            @if ( get_setting('widget_one_labels',null,App::getLocale()) !=  null )
                                @foreach (json_decode( get_setting('widget_one_labels',null,App::getLocale()), true) as $key => $value)
                                @php
