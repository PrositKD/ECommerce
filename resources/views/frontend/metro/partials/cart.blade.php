...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}">
    <span class="position-relative d-inline-block">
        ...
        @if(count($carts)>0)
            <span class="badge badge-primary badge-inline badge-pill absolute-top-right--10px">{{ count($carts)}}</span>
        @endif
    </span>
    ...
    <!-- <span class="nav-box-text d-none d-xl-block fs-16" style="color: #919199;">
        ...
        <span class="cart-count">{{count($carts) > 0 ? count($carts) : 0 }}</span> {{translate('')}}
