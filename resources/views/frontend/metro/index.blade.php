...
@section('content')
                        ...
                        @foreach ($sliders as $key => $slider)
                            <div class="carousel-box">
                                <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                    <!-- Image -->
                                    <div class="d-block mw-100 img-fit overflow-hidden h-100px h-md-220px h-lg-260px h-xl-283px overflow-hidden">
    ...
    <!-- @if (get_setting('home_banner1_images') != null)
        <div class="pb-2 pb-md-3 pt-4 pt-md-3" style="background: #f5f5fa;">
            <div class="d-flex mb-2 mb-md-3 px-10px align-items-baseline justify-content-center ">
               
                <h3 class="fs-16 fw-700 mb-2 mb-sm-0">
                    <span class="">{{ translate('DEALS YOU CANNOT MISS') }}</span>
                </h3>
            </div>
            <div class="mb-2 mb-md-3">
                @php
                    $banner_1_imags = json_decode(get_setting('home_banner1_images', null, $lang));
                    $data_md = count($banner_1_imags) >= 4 ? 4 : 2;
                @endphp
                <div class="w-100 ">
                    <div class="aiz-carousel gutters-16 overflow-hidden arrow-inactive-none arrow-dark arrow-x-15"
                        ...
                        data-md-items="{{ $data_md }}" data-sm-items="3" data-xs-items="2" data-arrows="true"
                        data-dots="false">
...
@if (count($featured_categories) > 0)
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="bg-white px-sm-3 mx-1">
            <div class="row">
            @php $limit = 12; @endphp
                @foreach ($featured_categories as $key => $category)
                    ...
                    @endphp
                    <div class="col-md-2 col-sm-4 col-6 mb-md-5 mb-3">
                        <a href="{{ route('products.category', $category->slug) }}" class="category-box position-relative p-0 has-transition mb-2">
                            <div class="h-100 pb-30px">
                                <img src="{{ isset($category->coverImage->file_name) ? my_asset($category->coverImage->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                                    alt="{{ $category_name }}"
                                    class="has-transition img-fit"
                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                            </div>
                            <div class="category-overlay">
                                <div class="align-items-center animate-underline-white d-flex fw-700 home-category-name hov-column-gap-1 justify-content-center text-black">
                                    <p>{{ $category_name }}</p>
...
@endif
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="">
                <div class="bg-white">
                    ...
                    <div class="align-items-baseline d-flex justify-content-center mb-2 mb-md-3 mt-2 mt-md-3 px-10px">
                      
                        <h3 class="fs-16 fw-700 mb-2 mb-sm-0">
                            <span class="">{{ translate('SHOP BEAUTY PRODUCTS BY CATEGORY') }}</span>
                        </h3>
                    </div>
                </div> -->
                <!-- Categories --><!-- fixx -->
                    <!-- <div class="bg-white px-sm-3 mx-1">
                        <div class="aiz-carousel sm-gutters-17" data-items="5" data-xxl-items="5" data-xl-items="4.5"
                            data-lg-items="4" data-md-items="3" data-sm-items="3" data-xs-items="2" data-arrows="true"
                            ...
                            @foreach ($featured_categories as $key => $category)
                                ...
                                <div class="carousel-box position-relative p-0 has-transition border-right border-top border-bottom @if ($key == 0) border-left @endif">
                                    <div class="h-100px h-sm-130px h-md-240px">
    ...
    @if ($flash_deal != null)
        <section class="mb-2 mb-md-3 mt-2 mt-md-3" style="background: {{ ($flash_deal_bg_full_width && $flash_deal_bg != null) ? $flash_deal_bg : '' }};" id="flash_deal">
            <div class="">
                ...
                <div class="bg-white mb-3 d-lg-none">
                ...
                <div class="row no-gutters align-items-center" style="background: {{ $flash_deal_bg }};">
                    ...
                    <div class="col-xxl-12 col-lg-12 col-12">
                        <div class="pl-3 pr-lg-3 pl-xl-2rem pr-xl-2rem">
                            ...
                            <div class="d-none d-lg-flex flex-wrap mb-2 mb-md-3 align-items-center justify-content-between">
                                <!-- Title -->
                                <h3 class="fs-16 fs-md-20 fw-700 mb-2">
                                    ...
                                    <span class=" border-left border-soft-light border-width-2 pl-3">
                                            <a href="{{ route('flash-deal-details', $flash_deal->slug) }}"
                                                class="fs-10 fs-md-12 fw-700 has-transition {{ $flash_deal_banner_menu_text }} @if (get_setting('flash_deal_banner_menu_text') == 'light') text-white opacity-60 hov-opacity-100 animate-underline-white @else text-reset opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary @endif">{{ translate('View All') }}</a>
                                        </span>
                                </h3>
                            ...
                            <div class="aiz-carousel border-top @if (count($flash_deal_products) > 8) border-right @endif arrow-inactive-none arrow-x-0"
                                data-items="5" data-xxl-items="5" data-xl-items="3.5" data-lg-items="4" data-md-items="4"
                                data-sm-items="3.5" data-xs-items="3" data-arrows="true" data-dots="false">
                                @php
                                    $init = 0;
                                    $end = 1;
                                @endphp
 ...
 @if (get_setting('top_brands') != null)
        <section class="mb-2 mb-md-3 mt-2 mt-md-3" style="background: #f5f5fa";>
            <div class="px-10px">
                <!-- Top Section -->
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    <!-- Title -->
                    <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">{{ translate('Trending-Brands') }}</h3>
                    <!-- Links -->
                    <div class="d-flex">
    ...
    <!-- Featured Products -->
    <div  class="pt-2 pt-md-3" style="background: #f5f5fa;">
        @if (count($get_featured_products_all) > 0)
            <section class="mb-2 mb-md-3 mt-2 mt-md-3">
                <div class="">
                    <!-- Top Section -->
                    <div class="d-flex mb-2 mb-md-3 px-10px align-items-baseline justify-content-center ">
                        <!-- Title -->
                        <h3 class="fs-16 fw-700 mb-2 mb-sm-0">
                            <span class="">{{ translate('RECOMMEND') }}</span>
                        </h3>
                        <!-- Links -->
                        {{-- <div class="d-flex">
                    ...
                    <!-- Products Section -->
                    <div class="row mx-2">
                        @foreach ($get_featured_products_all as $key => $product)
                            <div class="col-md-3 col-lg-2 col-6 col-sm-4 position-relative px-0 has-transition hov-animate-outline border-right border-top border-bottom @if($key == 0) border-left @endif">
                                <div class="px-2 mb-3 custom-product-box">
