...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $get_featured_products_all = Cache::remember('featured_products', 3600, function () {
            $product_query = Product::query();
            return filter_products($product_query->where('featured', '1'))->latest()->get();
        });

        return view('frontend.'.get_setting('homepage_select').'.index', compact('featured_categories', 'get_featured_products_all','lang'));
